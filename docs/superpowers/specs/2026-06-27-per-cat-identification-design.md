...
| Color collar (**pink=Ucok / green-blue=Garfield**) | tabby-splitter | ✗ (color gone) | ON-CAMERA color (Ucok's is orange IRL but renders pink — key on pink); owner-confirmed 2026-06-27 |
